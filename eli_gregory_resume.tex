...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \item Early hire to venture backed Silicon Valley startup, the "Uber for home remodeling".
      \item Built, tested and shipped client app - from zero to one.
      ...
      \item Led tech eval of Skip.tools, a Swift \& SwiftUI -> Kotlin \& Jetpack Compose transpiler for cross platform app development.
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \item Lead a multi-disciplinary team building a portfolio of 14 location based apps across 7 platforms, published in open source. Github community insights reported 100+ daily unique clones, collectively.
